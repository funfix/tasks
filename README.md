...
Read the [Javadoc](https://javadoc.io/doc/org.funfix/tasks-jvm/0.5.0/org/funfix/tasks/jvm/package-summary.html).
...
```kotlin
dependencies {
    implementation("org.funfix:tasks-jvm:0.5.0")
}
```

sbt:
```scala
libraryDependencies += "org.funfix" % "tasks-jvm" % "0.5.0"
```
